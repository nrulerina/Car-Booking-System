...
// 1. Convert form date to ISO8601
...
$sql="UPDATE tb_booking
      SET b_req='$fvehicle', b_pdate='$fpdate', b_rdate='$frdate', b_total='$totalprice', b_status='1'
      WHERE b_id='$fbid'";
...
// Set the body of the email for updating a booking
$mail->Body = 'Thank you for reaching out to update your booking. Please wait for staff approval. We will contact you via WhatsApp once the updated booking is confirmed.';
          ...
          <div class="container mt-4">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <p class="card-text">Here are your updated booking details:</p>
              </div>
            </div>
          </div>
        </div>
